    ...
    public class Aula04
    {
        public static void Executar()
        {
            ...
            string diretorioEntrada = @"C:\Users\" + usuario +
                                      @"\Projects-Idea\Projects-Rider\Curso\H-arquivos\Aula04\arquivo1.txt";
            string diretorioSaida = @"C:\Users\" + usuario +
                                    @"\Projects-Idea\Projects-Rider\Curso\H-arquivos\Aula04\arquivo2.txt";
