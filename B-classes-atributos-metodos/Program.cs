using System;
using B_classes_atributos_metodos.Aula02.versao1;
using B_classes_atributos_metodos.Aula02.versao2;
using B_classes_atributos_metodos.Aula02.versao3;

namespace B_classes_atributos_metodos
{
    class Program
    {
