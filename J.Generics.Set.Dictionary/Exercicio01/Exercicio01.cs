...
namespace J.Generics.Set.Dictionary.Exercicio01
{
    public class Exercicio01
    {
        public static void Executar()
        {
            ...
            string diretorio = @"C:\Users\" + usuario +
                               @"\Projects-Idea\Projects-Rider\Curso\J-Generics-set-dictionary\Exercicio01\arquivo.txt";
