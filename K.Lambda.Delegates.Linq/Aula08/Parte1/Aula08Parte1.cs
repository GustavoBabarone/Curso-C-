using System;
using System.Linq;
using K.Lambda.Delegates.Linq.Aula08.Common;

namespace K.Lambda.Delegates.Linq.Aula08.Parte1
{
    public class Aula08Parte1
    {
        public static void Executar()
        {
            ...
            Utils.ImprimirColecao("--- Classificação 1 ordenado por preço e depois por nome com Skip 2 e Take 4 ---",
                resultado5);
